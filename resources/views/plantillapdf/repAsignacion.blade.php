			...
			<tr>
				<td>
					<div style="width: 5cm; height: 2.5cm; text-align: center;">
						<img src="{{ asset('img/logo_senape.png') }}" alt="" style="width: auto; height: 2cm; ">
					</div>
				</td>
				<td>
					<div style="width: 14.5cm; height: 2cm;">
					<p style="margin-top: 0.5cm; text-align: center;" ><b>ACTA DE INVENTARIO DE BIENES</b></p>
		...
		<table id="cabecera">
			<tr style=" height: .5cm;">
				...
				<td style=" height: .5cm; width:7cm;">
					<p style="font-size: x-small; margin: 0.1cm;">SERVICIO NACIONAL DE PATRIMONIO DEL ESTADO</p>
				</td>
				<td>
				<p style="font-size: x-small;  margin: 0.1cm;"><b>UNIDAD:</b> OFICINA CENTRAL LA PAZ </p>
				</td>
			</tr>
			<tr style=" height: .5cm;">
				<td >
			...
			<tr>
				<td>
					<div style=" text-align: center; width: 8.66cm;">
						...
						<p style="font-size: x-small; margin: 0.1cm;">Inventariador</p>
					</div>
				</td>
				<td>
					<div style=" text-align: center; width: 8.66cm;">
						<p style="margin: 0.1cm; text-align: center;">_____________________________</p>
						<p style="font-size: x-small; margin: 0.1cm;">VoBo</p>
					</div>
				</td>
				<td>
					<div style=" text-align: center; width: 8.66cm;">
